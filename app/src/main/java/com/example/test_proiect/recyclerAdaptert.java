...
public class recyclerAdaptert extends RecyclerView.Adapter<recyclerAdaptert.MyViewHolder> {
    ...
    public recyclerAdaptert(ArrayList<Obiect> objsList, RecyclerViewClickListener listener){
    ...
    @NonNull
    @Override
    public recyclerAdaptert.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_items, parent,false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull recyclerAdaptert.MyViewHolder holder, int position) {
